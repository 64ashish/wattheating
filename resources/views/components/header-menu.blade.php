<nav>
    <div class="h-20 px-4 grid grid-cols-3 items-center lg:hidden">
        ...
        <div class="flex justify-end">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 stroke-primary-500">
...
{{--                text-[#005874]--}}
                <ul class="inline-flex gap-x-10 text-secondary-900 font-semibold text-lg	">
                    <li>Våra produkter</li>
                    <li class="text-black text-opacity-30">|</li>
                    <li>Privatkund?</li>
                </ul>
            </div>
            <div class="flex items-center gap-x-7">
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 stroke-secondary-900">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                </div>
                <div>
